...
<div class="container mt-5 card-body">
    <form action="{{route('demande_employee.demande_employee')}}" method="POST" enctype="multipart/form-data">
  <a onclick="return confirm('Voulez-vous annuler demande d\'emploie ?');" href="{{route('carwash.index')}}" class="btn btn-secondary btn-lg my-3">Précedent </a>
            ...
            @csrf
              ...
              <div class="form-row row mt-5 ">
                  <div class="form-group col-md-4">
                      ...
                      <input type="file" class="form-control-file mt-3" name="copy_cin">
                  </div>
                  <div class="form-group col-md-4">
                      <label for="copy_permis">Photo Permis</label>
                      <input type="file" class="form-control-file mt-3" name="copy_permis">
                  </div>
                  <div class="form-group col-md-4">
                      <label for="photo">Photo Personnel</label>
                      <input type="file" class="form-control-file mt-3" name="photo">
                  </div>
              </div>
